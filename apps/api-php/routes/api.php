...
$routes = [
    ...
    ['GET', '/orders/:id/timeline', ['Amare\Api\Controllers\OrderController', 'timeline']],
    ...
    ['GET', '/restaurants/tables/session-diagnostic', ['Amare\Api\Controllers\SocialController', 'tableSessionDiagnostic']],
    ...
    ['GET', '/admin/social/photos', ['Amare\Api\Controllers\AdminController', 'socialPhotoQueue']],
