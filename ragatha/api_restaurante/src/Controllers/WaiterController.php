...
class WaiterController
{
    ...
    public function createSplit(int $tableId): void
    {
        ...
        try {
            ...
            if (!empty($this->getOpenGiftChargesForTable($restaurantId, $tableId))) {
                throw new \DomainException('Esta mesa tiene regalos pendientes cargados a la cuenta. Cobrala en una sola cuenta.');
            }
